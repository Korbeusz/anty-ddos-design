...
class TCPParserTestCircuit(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.parser = self.parser = TCPParser(push_parsed=self.mock_push_parsed.adapter.iface)
...
class TestTCPParser(TestCaseWithSimulator):
    def setup_method(self):
        ...
        short_bytes_4 = bytes.fromhex(
            "123456780000000100000002"  # 12 bytes
        )
        short_in_4 = {
        ...
        chunk4_4 = tcp_bytes_four_chunk[192:220].ljust(64, b'\x00')  # 28 bytes payload, padded to 64
    ...
    async def dout_process(self, sim: TestbenchContext):
        ...
        for i, expected in enumerate(self.expected_parsed):
            ...
            assert parsed_fields["window_size"] == expected["window_size"], \
            ...
            assert parsed_fields["urgent_pointer"] == expected["urgent_pointer"], \
