...
class IPv4ParserTestCircuit(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        m.submodules.parser = self.parser = IPv4Parser(push_parsed=self.mock_push_parsed.adapter.iface)
...
class TestIPv4Parser(TestCaseWithSimulator):
    ...
    def setup_method(self):
        ...
        short_bytes_4 = bytes.fromhex(
            "450000401234"  # 12 bytes (partial header)
        )
        short_in_4 = {
