...
module top(rst_n, in_data, in_valid, in_empty, out_full, \clk$9 , rst, rd_en_fifo, out_data, wr_en_fifo, clk);
  input clk;
  wire clk;
  wire \clk$11 ;
  wire \clk$20 ;
...
module \top.main_module (in_valid, in_empty, out_full, clk, rst, rd_en_fifo, wr_en_fifo, out_data, in_data);
