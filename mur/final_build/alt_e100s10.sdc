...
if {0} {	
set RX_CLK0 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|rx_pcs_x2_clk|ch0]
set RX_CLK1 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|rx_pcs_x2_clk|ch1]
set RX_CLK2 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|rx_pcs_x2_clk|ch2]
set RX_CLK3 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|rx_pcs_x2_clk|ch3]
set TX_CLK0 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|tx_pcs_x2_clk|ch0]
set TX_CLK1 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|tx_pcs_x2_clk|ch1]
set TX_CLK2 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|tx_pcs_x2_clk|ch2]
set TX_CLK3 [get_clocks ex_100g_inst|ex_100g_inst|xcvr|tx_pcs_x2_clk|ch3]

set_clock_groups -exclusive -group $RX_CLK0 -group $CLK100
set_clock_groups -exclusive -group $RX_CLK1 -group $CLK100
set_clock_groups -exclusive -group $RX_CLK2 -group $CLK100
set_clock_groups -exclusive -group $RX_CLK3 -group $CLK100
set_clock_groups -exclusive -group $TX_CLK0 -group $CLK100
set_clock_groups -exclusive -group $TX_CLK1 -group $CLK100
set_clock_groups -exclusive -group $TX_CLK2 -group $CLK100
set_clock_groups -exclusive -group $TX_CLK3 -group $CLK100
}
...
for {set chNum 0} {$chNum < 4} {incr chNum} {
  ...
  set_clock_groups -exclusive -group $TX_CLK -group $CLK100
  set_clock_groups -exclusive -group $RX_CLK -group $CLK100  
}
